export default {
  ...
  gameMechanicsText: 'Attacking a player, Eliminating players, Team play, Hand management, Hidden roles, Different abilities of players, Team cooperation, Upgrade abilities with cyber implants.',
  about: 'About',
  lore: 'Lore',
  aboutLoreText: 'In a world where cyber technologies have transformed society, and where anyone could be a technologically modified cyborg, a conflict exists between a technically-sabotage group of talented hackers, and \n' +
  ...
  footerText: 'We use cookies to enhance your browsing experience and analyse our traffic. By clicking "Accept All", you consent to our use of cookies.',
