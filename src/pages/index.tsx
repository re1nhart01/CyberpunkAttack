...
const { FBlockWrapper, FBlockContainer, FHeaderWrapper, Del, ContainedRowView, VerticalLineWhite2 } = HomePageStyles;
const { Text76orbitron700, Text18boxed500, Text24boxed600, Text16boxed500, Text16boxed600, Text16boxed700 } = TypographyComponents;
const { FbBlurRowImg, CardImageView } = ImageViewComponents;
